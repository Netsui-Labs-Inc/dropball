...
<a href='{{route('admin.master-agents.wallet',['sorts' => ['created_at' => 'desc'], 'masterAgent' => $user])}}' class='btn btn-sm btn-info text-white'><i class='fa fa-dollar-sign'></i> Transactions</a>
