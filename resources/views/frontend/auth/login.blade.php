...
@section('content')
    <div class="header bg-gradient-red py-6 py-lg-6 pt-lg-8">
        <div class="container">
            <div class="header-body text-center mb-7">
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-lg-6 col-md-8 px-5">
                        <h1 class="h1 text-white text-uppercase"><i class="fa fa-circle-notch"></i> {{ config('app.name') }}</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card bg-secondary shadow border-0 mb-2">
                    <div class="card-header bg-default pb-2">
                        <div class="btn-wrapper text-center">
                            <h2 class="text-danger text-uppercase"> Sign in</h2>
                        </div>
                    </div>
                        ...
                        <x-forms.post :action="route('frontend.auth.login')">
                            ...
                            <div class="form-group focused">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control" name="password" placeholder="Password" type="password" autocomplete="off" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;">
                                </div>
                            </div>
