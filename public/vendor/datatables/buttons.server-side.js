(function ($, DataTable) {
    ...
    DataTable.ext.buttons.balance_deduction = {
        className: 'btn-sm btn-danger',

        text: function (dt) {
            return '<i class="fa fa-dollar-sign"></i> ' + dt.i18n('buttons.deduct', 'Deduct Balance');
        },
    ...
    $("#dataTableBuilder").find('thead').addClass("thead-light");
