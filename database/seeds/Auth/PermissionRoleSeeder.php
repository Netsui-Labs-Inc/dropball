    ...
    public function run()
    {
        ...
        $users->children()->saveMany([
            ...
            new Permission([
                ...
                'description' => 'View BettingRounds',
                'sort' => 12,
            ]),
            new Permission([
                'type' => User::TYPE_ADMIN,
                'name' => 'admin.access.players.info',
                'description' => 'View BettingRound Info',
                'sort' => 13,
            ]),
            new Permission([
                'type' => User::TYPE_ADMIN,
                'name' => 'admin.access.players.wallet',
                'description' => 'Manage BettingRounds Wallet',
                'sort' => 14,
            ]),
            new Permission([
                'type' => User::TYPE_ADMIN,
            ...
            new Permission([
                ...
                'description' => 'Create BettingRounds',
                'sort' => 16,
            ]),
            new Permission([
                'type' => User::TYPE_ADMIN,
                'name' => 'admin.access.plays.edit',
                'description' => 'Edit BettingRound',
                'sort' => 17,
            ]),
            new Permission([
                'type' => User::TYPE_ADMIN,
            ...
            new Permission([
                ...
                'description' => 'View BettingRound Bets',
                'sort' => 19,
            ]),
            new Permission([
                'type' => User::TYPE_ADMIN,
                'name' => 'admin.access.plays.moderate',
                'description' => 'Moderate BettingRound',
                'sort' => 20,
            ]),
            new Permission([
                'type' => User::TYPE_ADMIN,
