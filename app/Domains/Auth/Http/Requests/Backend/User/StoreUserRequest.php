...
class StoreUserRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'mobile' => ['sometimes', 'nullable','max:255', Rule::unique('users')->ignore(null, 'mobile')],
            'commission_rate' => ['nullable','in:1,1.25,1.5,1.75,2'],
            'hub_id' => ['nullable','exists:hubs,id'],
            'password' => ['max:100', PasswordRules::register($this->email)],
            'active' => ['sometimes', 'in:1'],
            'referral_id' => ['sometimes', 'nullable', 'max:100', Rule::unique('users')->ignore(null, 'referral_id')],
