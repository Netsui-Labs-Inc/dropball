...
class MyAccountController extends Controller
{
    ...
    {
        $result = $userService->updateProfile($request->user(), $request->validated());
        ...
        return (!$result['error']) ? redirect()->route('admin.auth.my-account', ['#information'])->withFlashSuccess(__('Profile successfully updated.')) :
